...
# service_to_http_error_map: _ServiceToHttpErrorMap = {
#     ErrorCode.ACCOUNT_EXISTS.name: HTTPException(
#         detail={
...
#     ErrorCode.ACCOUNT_EXISTS.name = HttpError(
#         status_code=status.HTTP_404_NOT_FOUND, detail=ErrorDetail(display_message="", code="")
#     )
#     #     detail={
#     #         "display_message": "Account not found for provided credentials.",
#     #         "code": "NO_ACCOUNT_FOUND",
