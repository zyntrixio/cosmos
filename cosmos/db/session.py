...
engine_kwargs = (
    ...
    | {"poolclass": NullPool}
    if db_settings.USE_NULL_POOL or db_settings.TESTING
    else {}
)
...
AsyncSessionMaker = async_sessionmaker(async_engine, future=True, expire_on_commit=False)
SyncSessionMaker = sessionmaker(sync_engine, future=True, expire_on_commit=False)
